...
out_path='emotion_work_complex_cnn_lstm_att_adam_tf_mfcc_essentia'
...
for train_index, test_index in kf.split(np.array(shuffle_indices)):
	...
	common=Bidirectional(LSTM(LSTM_UNITS,recurrent_dropout=0.2,dropout=0.2, return_sequences=True))(max_pool)							
	common=Bidirectional(LSTM(LSTM_UNITS,recurrent_dropout=0.2,dropout=0.2, return_sequences=True))(common)							
	common = AttLayer()(common)
							
	
	dense = (Dense(DENSE_UNITS, activation='tanh'))(common)
